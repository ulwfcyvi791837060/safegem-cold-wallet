...
public class RecyclerViewDivider extends RecyclerView.ItemDecoration {
     ...
     * @param context
     * @param orientation   列表方向
     * @param footerDivider true显示，false不显示
     */
    public RecyclerViewDivider(Context context, int orientation, boolean footerDivider) {
    ...
    private void drawHorizontal(Canvas canvas, RecyclerView parent) {
        ...
        final int childSize = footerDivider ? parent.getChildCount() : parent.getChildCount() - 1;
