...
package com.bankledger.safecold.scan.camera.open;
...
public final class OpenCameraInterface {
    ...
    public static OpenCamera open(int cameraId) {
        ...
        Camera.Size preSize = getCloselyPreSize(true, DPUtils.getWidthInDP(SafeColdApplication.mContext), DPUtils.getHeightInDP(SafeColdApplication.mContext), parameters.getSupportedPreviewSizes());
