...
package com.bankledger.safecoldj.message;
...
public abstract class Message {
     ...
     */
    protected Message(Currency mCurrency, byte[] msg, int offset, int protocolVersion, int length) throws ProtocolException {
    ...
    protected Message(Currency mCurrency, byte[] msg, int offset) throws ProtocolException {
        this(mCurrency, msg, offset, mCurrency.protocolVersion, UNKNOWN_LENGTH);
    }

    protected Message(Currency mCurrency, byte[] msg, int offset, int length) throws ProtocolException {
        this(mCurrency, msg, offset, mCurrency.protocolVersion, length);
    }
