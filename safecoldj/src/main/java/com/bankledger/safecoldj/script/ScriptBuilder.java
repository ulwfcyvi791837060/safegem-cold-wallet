...
package com.bankledger.safecoldj.script;
...
import static com.bankledger.safecoldj.script.ScriptOpCodes.OP_RETURN;
import static com.google.common.base.Preconditions.checkArgument;
import static com.bankledger.safecoldj.script.ScriptOpCodes.OP_0;
import static com.bankledger.safecoldj.script.ScriptOpCodes.OP_CHECKMULTISIG;
import static com.bankledger.safecoldj.script.ScriptOpCodes.OP_CHECKSIG;
import static com.bankledger.safecoldj.script.ScriptOpCodes.OP_DUP;
import static com.bankledger.safecoldj.script.ScriptOpCodes.OP_EQUAL;
import static com.bankledger.safecoldj.script.ScriptOpCodes.OP_EQUALVERIFY;
import static com.bankledger.safecoldj.script.ScriptOpCodes.OP_HASH160;
import static com.bankledger.safecoldj.script.ScriptOpCodes.OP_PUSHDATA1;
import static com.bankledger.safecoldj.script.ScriptOpCodes.OP_PUSHDATA2;
import static com.bankledger.safecoldj.script.ScriptOpCodes.OP_PUSHDATA4;

/**
 * <p>Tools for the construction of commonly used script types. You don't normally need this as it's hidden behind
 * convenience methods on {@link com.bankledger.safecoldj.core.Tx}, but they are useful when working with the
...
public class ScriptBuilder {
     ...
     */
    public static Script createOutputScript(String to, Currency mCurrency) throws AddressFormatException {
        if (Utils.getAddressHeader(to) == mCurrency.p2shHeader) {
            ...
            return new ScriptBuilder()
                    ...
                    .op(OP_EQUAL)
                    .build();
        } else if (Utils.getAddressHeader(to) == mCurrency.addressHeader) {
