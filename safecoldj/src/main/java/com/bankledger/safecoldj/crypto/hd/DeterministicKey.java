 ...
 */
package com.bankledger.safecoldj.crypto.hd;
...
public class DeterministicKey extends ECKey {
    ...
    /**
     * Returns the last element of the path returned by {@link com.bankledger.safecoldj.crypto.hd.DeterministicKey#getPath()}
     */
...
//    }
    ...
    /**
     * Returns this keys {@link com.bankledger.safecoldj.crypto.KeyCrypter} <b>or</b> the keycrypter of its parent key.
     */
    @Override
    @Nullable
...
//    }
    ...
    @Override
    public DeterministicKey decrypt(KeyCrypter keyCrypter, KeyParameter aesKey) throws KeyCrypterException, PasswordException {
        checkNotNull(keyCrypter);
    ...
    private BigInteger findOrDeriveEncryptedPrivateKey(KeyCrypter keyCrypter, KeyParameter aesKey) throws PasswordException {
