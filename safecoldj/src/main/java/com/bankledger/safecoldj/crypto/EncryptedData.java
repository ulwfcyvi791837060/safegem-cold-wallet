...
public class EncryptedData {
    ...
    public EncryptedData(String str) {
        ...
        initialisationVector = Utils.hexStringToBytes
                (strs[1]);
        encryptedData = Utils.hexStringToBytes(strs[0]);
        byte[] saltQRCodes = Utils.hexStringToBytes(strs[2]);
    ...
    public byte[] decrypt(CharSequence password) throws PasswordException {
    ...
    public static String changePwd(String encryptStr, CharSequence oldPassword, CharSequence newPassword) throws PasswordException {
    ...
    public static String changePwdKeepFlag(String encryptStr, CharSequence oldPassword, CharSequence newPassword) throws PasswordException {
        EncryptedData encrypted = new EncryptedData(encryptStr);
