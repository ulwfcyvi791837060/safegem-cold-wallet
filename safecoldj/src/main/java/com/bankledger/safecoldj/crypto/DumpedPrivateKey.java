...
public class DumpedPrivateKey {
    ...
    public DumpedPrivateKey(byte[] keyBytes, boolean compressed, Currency mCurrency) {
        version = mCurrency.dumpedPrivateKeyHeader;
     ...
     * @throws com.bankledger.safecoldj.exception.AddressFormatException If the string is invalid or the header byte doesn't match the network params.
     */
    public DumpedPrivateKey(String encoded, Currency mCurrency) throws AddressFormatException {
        //todo string encoded
