...
public class TransactionSignature extends ECKey.ECDSASignature {
    ...
    private static final Logger log = LoggerFactory.getLogger(TransactionSignature.class);
    ...
    public static int calcSigHashValue(SigHash mode, boolean anyoneCanPay) {
        ...
        boolean fUseForkId = (mode.value & SigHash.FORKID.value) > 0;
        log.info("------fUseForkId = {}", fUseForkId);
        if (fUseForkId) {
